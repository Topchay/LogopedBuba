...
public class Level6 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject winPanel, loosPanel, blini, levelBar, daleeButton;

    [SerializeField] private AudioClip audioIntro;
    [SerializeField] private AudioClip audioIntro2;
    [SerializeField] private AudioClip audioWin;
    [SerializeField] private AudioClip audioLose;

    [SerializeField] private AudioClip[] audioBlini;
    ...
    private IEnumerator PlayAudioAndActivate()  // Ждем ее балабольство, потом начинается игра
    {
        ...
        audioSource.clip = audioIntro2;         
        audioSource.Play();

        yield return new WaitForSeconds(audioIntro2.length); 
    ...
    private void StartNextRound()
    {
        ...
        {
            cTime = startTime;
            audioSource.clip = audioBlini[currentNumber];
            audioSource.Play();
            isGameActive = true;
        }
        else
